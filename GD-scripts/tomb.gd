...
var dialogues = [
	{
		...
		"animation": "dirty",
		"choices": [
			{ "text": "Pay Respects and clean grave", "score_change": 2, "response_animation": "Happy", "next_index": 1 },
			{ "text": "Ignore and move on", "score_change": -2, "response_animation": "Angry", "next_index": 2 }
		]
	},
	{
		"name": "Grave",
	...
	{
		"name": "Grave",
		"text": "You should have paid your respects...",
		"delay": 2.0,
		"animation": "dirty",
		"choices": []
	}
